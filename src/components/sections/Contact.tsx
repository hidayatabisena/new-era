...
export default function Contact() {
    return (
        <section id="contact" className="py-24 md:py-32 px-4 bg-background border-t border-border/40">
            <div className="max-w-4xl mx-auto text-center">
                ...
                >
                    ...
                    <div className="mt-20 text-sm text-text-secondary/60">
                        &copy; {new Date().getFullYear()} Hidayat Abisena. All rights reserved.
                    </div>
                </motion.div>
            </div>
        </section>
